...
//
// this is a copy of datafusion rule, with some differences
// needed to make this rule working on ballista
//
// see: https://github.com/apache/datafusion-ballista/issues/1304
// for more details
//
use std::sync::Arc;
...
mod test {
    ...
    //
    // more details at:
    // https://github.com/apache/datafusion-ballista/issues/1304
    //
    #[rstest::rstest(
        join_type,
    ...
    async fn test_nl_join_with_swap(join_type: JoinType) {
        ...
        use datafusion::{
            ...
            physical_plan::{displayable, joins::NestedLoopJoinExec},
        };
