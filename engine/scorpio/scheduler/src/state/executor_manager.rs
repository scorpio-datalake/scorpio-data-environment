...
use scorpio_core::serde::protobuf::executor_grpc_client::ExecutorGrpcClient;
use scorpio_core::serde::protobuf::{
...
use scorpio_core::utils::{GrpcClientConfig, create_grpc_client_endpoint, get_time_before};
    ...
    pub(crate) fn is_dead_executor(&self, executor_id: &str) -> bool {
        self.cluster_state
            ...
            .is_none_or(|heartbeat| {
                matches!(
                    heartbeat.status,
                    Some(scorpio_core::serde::generated::ballista::ExecutorStatus {
