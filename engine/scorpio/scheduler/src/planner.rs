...
use scorpio_core::execution_plans::sort_shuffle::SortShuffleConfig;
use scorpio_core::{
    execution_plans::{
    ...
    async fn distributed_aggregate_plan() -> Result<(), BallistaError> {
        ...
        ShuffleWriterExec: partitioning: Hash([l_returnflag@0], 2)
          AggregateExec: mode=Partial, gby=[l_returnflag@1 as l_returnflag], aggr=[sum(lineitem.l_extendedprice * Int64(1))]
            DataSourceExec: file_groups={2 groups: [[scorpio/scheduler/testdata/lineitem/partition0.tbl], [scorpio/scheduler/testdata/lineitem/partition1.tbl]]}, projection=[l_extendedprice, l_returnflag], file_type=csv, has_header=false
...
",
        ...
        ShuffleWriterExec: partitioning: Hash([l_orderkey@0], 2)
          FilterExec: (l_shipmode@4 = MAIL OR l_shipmode@4 = SHIP) AND l_receiptdate@3 > l_commitdate@2 AND l_shipdate@1 < l_commitdate@2 AND l_receiptdate@3 >= 1994-01-01 AND l_receiptdate@3 < 1995-01-01, projection=[l_orderkey@0, l_shipmode@4]
            DataSourceExec: file_groups={2 groups: [[scorpio/scheduler/testdata/lineitem/partition0.tbl], [scorpio/scheduler/testdata/lineitem/partition1.tbl]]}, projection=[l_orderkey, l_shipdate, l_commitdate, l_receiptdate, l_shipmode], file_type=csv, has_header=false

        ShuffleWriterExec: partitioning: Hash([o_orderkey@0], 2)
          DataSourceExec: file_groups={1 group: [[scorpio/scheduler/testdata/orders/orders.tbl]]}, projection=[o_orderkey, o_orderpriority], file_type=csv, has_header=false
    ...
    async fn distributed_window_plan() -> Result<(), BallistaError> {
        ...
        /*
            ...
            ShuffleWriterExec: partitioning: Hash([l_shipmode@1], 2)
              DataSourceExec: file_groups={2 groups: [[scorpio/scheduler/testdata/lineitem/partition0.tbl], [scorpio/scheduler/testdata/lineitem/partition1.tbl]]}, projection=[l_shipdate, l_shipmode], file_type=csv, has_header=false
