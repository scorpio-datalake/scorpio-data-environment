...
# Default package is scorpio-core. Use --workspace for the full suite.
#
# Examples:
...
usage() {
    ...
    echo "Options:"
    echo "  -p, --package NAME   Crate name (default: scorpio-core)"
    ...
    echo "      --build-binary   With single package: --features build-binary (scorpio-core object_store)"
